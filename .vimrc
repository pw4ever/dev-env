...
" Plugins
" set runtimepath+=$HOME/.vim/extras/bash-support
" set runtimepath+=$HOME/.vim/extras/latexSuite
" set runtimepath+=$HOME/.vim/extras/lua-support
" set runtimepath+=$HOME/.vim/extras/perl-support
" set runtimepath+=$HOME/.vim/extras/slimv
" set runtimepath+=$HOME/.vim/extras/taglist
" set runtimepath+=$HOME/.vim/extras/vcscommand
" set runtimepath+=$HOME/.vim/extras/zencoding
" set runtimepath+=$HOME/.vim/extras/autocomplpop
" set runtimepath+=$HOME/.vim/extras/omnicppcomplete
" set runtimepath+=$HOME/.vim/extras/cvim
